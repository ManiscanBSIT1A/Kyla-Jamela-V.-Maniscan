...
public class ChangingFace extends Application {
    ...
    public void start(Stage stage) {
        ...
        // create a button that will make the face blank
        ...
        buttonBox.getChildren().addAll(smileButton, frownButton, blankButton);
        ...
        // supply the code that is executed when the frown button is pressed
        blankButton.setOnAction(e -> mouth.setLength(0));
